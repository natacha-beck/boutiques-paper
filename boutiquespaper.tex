...
%% nb: In CBRAIN we leverage the ability of Singularity to pull and 
%% convert Docker image directly.
...
described later. 
%% nb: The parralelization of FSL-randomise was removed in CBRAIN it 
%% did not work properly, do we use the parralelization for other FSL tools
